...
class InternationalController {
  ...
  public async createInternationalOrder(req: Request, res: Response): Promise<void> {
    try {
      const newOrder = {
...
public async getAllInternationalOrders(req: Request, res: Response): Promise<void> {
    try {
  ...
  public async getInternationalOrderById(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
